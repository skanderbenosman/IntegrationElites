...
public class EmployeServiceImplTest {
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("87");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(87, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("87"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("3"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("86");
	Assert.assertNull(us.retrieveEmploye("86"));
	}
