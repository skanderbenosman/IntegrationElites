...
public class EmployeServiceImplTest {
	...
	//	System.out.println("***"+uc.retrieveContrat("1") );
		Employe u = new Employe("skander", "ben osman", "mohamed.mselmi1@esprit.tn","123456", d, Role.INGENIEUR,uc.retrieveContrat("3")); 
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("55");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(55, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("55"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("2"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("52");
	Assert.assertNull(us.retrieveEmploye("52"));
	}
