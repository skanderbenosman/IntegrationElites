...
public class EmployeServiceImplTest {
	...
	//	System.out.println("***"+uc.retrieveContrat("1") );
		Employe u = new Employe("skander", "ben osman", "mohamed.mselmi1@esprit.tn","123456", d, Role.INGENIEUR,uc.retrieveContrat("2")); 
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("56");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(56, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("56"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("2"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("55");
	Assert.assertNull(us.retrieveEmploye("55"));
	}
