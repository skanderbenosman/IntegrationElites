...
public class EmployeServiceImplTest {
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("85");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(85, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("85"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("1"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("83");
	Assert.assertNull(us.retrieveEmploye("83"));
	}
