...
public class EmployeServiceImplTest {
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("75");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(75, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("75"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("2"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("74");
	Assert.assertNull(us.retrieveEmploye("74"));
	}
