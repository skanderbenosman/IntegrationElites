...
public class EmployeServiceImplTest {
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("82");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(82, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("82"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("2"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("81");
	Assert.assertNull(us.retrieveEmploye("81"));
	}
