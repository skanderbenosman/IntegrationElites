...
public class EmployeServiceImplTest {
	...
	public void testRetrieveEmploye() {
		Employe userRetrieved = us.retrieveEmploye("79");
		System.out.println("resultat retrieve :" +userRetrieved);
		Assert.assertEquals(79, userRetrieved.getId().longValue());
	}
	...
	public void testModifyEmploye() throws ParseException   {
		...
		Employe u = new Employe( Long. valueOf("79"),"test1", "test1", "mohamed.mselmi1@esprit.tn","20251825", true, Role.INGENIEUR,uc.retrieveContrat("2"));
	...
	public void testDeleteEmploye() {
		us.deleteEmploye("78");
	Assert.assertNull(us.retrieveEmploye("78"));
	}
